...
namespace GameStoreAppCF.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Adress")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Adress")] Manufacturer manufacturer)
        {
            if (ModelState.IsValid)
            {
